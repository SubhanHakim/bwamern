...
import IconTravaler from "assets/images/icons/ic_traveler.svg";
          ...
          <div className="col-auto pr-5" style={{ width: 560 }}>
            ...
            <div className="row" style={{ marginTop: 80 }}>
              <div className="col-auto" style={{ marginRight: 35 }}>
                <img width="36" height="36" src={IconTravaler} alt={`${props.data.travelers} Travalers`} />
                <h6 className="mt-3">
                  {formatNumber(props.data.travelers)} <span className="text-gray-500 font-weight-light">Travalers</span>
                </h6>
              </div>
              <div className="col-auto" style={{ marginRight: 35 }}>
                <img width="36" height="36" src={IconTreasure} alt={`${props.data.treasure} Treasure`} />
                <h6 className="mt-3">
                  {formatNumber(props.data.treasure)} <span className="text-gray-500 font-weight-light">Treasure</span>
                </h6>
              </div>
              <div className="col-auto" style={{ marginRight: 35 }}>
