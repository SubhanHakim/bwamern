        ...
        <div className="row align-items-center">
          <div className="col-auto" style={{ marginRight: 70 }}>
            <div className="testimonial-hero" style={{ margin: `30px 0 0 30px` }}>
              <img className="position-absolute" src={data.imageUrl} alt="Testimonial" style={{ zIndex: 2 }} />
              <img className="position-absolute" src={TestimonyAccent} alt="Testimonial" style={{ margin: `-30px 0 0 -30px` }} />
            </div>
          </div>
          <div className="col">
